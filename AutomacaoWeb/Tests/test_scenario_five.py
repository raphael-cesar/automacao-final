...
def test_scenario_five(driver):
    ...
    for index in range(3):
        ...
        assert search_page.validate_product_name_is_shown_and_expected(product_name)
        ...
        assert product_page.validate_product_name_is_shown_and_expected(product_name)
