...
class ProfilePage(BasePage):
    def __init__(self, driver):
        ...
        self.SAVE_PASSWORD_BUTTON_CLASS = "vtex-button"
    ...
    def click_save_password(self):
        return self.click_element(By.CLASS_NAME, self.SAVE_PASSWORD_BUTTON_CLASS)
    
    #Validations
    def validate_save_password_button(self):
        return self.is_element_enabled(By.CLASS_NAME, self.SAVE_PASSWORD_BUTTON_CLASS)
